; Path: unixg.ubc.ca!kakwa.ucs.ualberta.ca!tribune.usask.ca!decwrl!decwrl!
;     news.doit.wisc.edu!uwm.edu!math.ohio-state.edu!howland.reston.ans.net!
;     paladin.american.edu!auvm!UTPVM1.BITNET!RPEREZ
...
; If you delete the Q or O in the condition, you will only see the imag or the
; real part of the method...
;
;  
; Zmag and Bof60:
