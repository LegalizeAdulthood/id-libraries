...
; and Mandelbrot, and a percentage (0.00 through 1.00) of Mandelbrot to be used.
;
; Example:
...
; to generate a series of fractals, what you will see is the coordinate location
; progressively enlarge, and flow into the final formation of a full Julia.
;
; Given the structure of Fractint's commands, relative to formula fractals, another
...
;       Set p2 (imaginary) =  0.0     (this is not used, and should always be 0.0)
;
;    d/ The distorted Mandelbrot-like fractal results. Notice that most interesting
; action is located near the coordinates used (-0.5, 0.65 = Center Top)
;
;    e/ Use you mouse to select an area inclosing the interesting area at the top
; RSQTITMJ.EXE's data was = Crt. -0.3755426   0.7703497   Mag.   1.7181998e+000
;
;    f/ Once your new fractal of the detailed area you pick has finished rendering:
;       Hit [Z] and change the p1(real) from -0.05, to -0.06, then hit enter.
;
;    g/ After each fractal generates (and is saved) continue the actions in "f/"
...
;
; This is just an example. Most of the FLICs I made have maintained the p1 coordinates,
; and varied the percentage variable p2(real) from 1.00 through 0.00, but generally,
