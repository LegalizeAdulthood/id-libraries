...
c=(-1.099,-0.2349)
z=conj(pixel^2.33)/log(2.667-pixel)^2.87-(1/log(acos(0.10/pixel+1.25)))^2.95,
z1=1.5*z , z2=2.25*z , z3=3.375*z , z4=11.0625*z,
l1=(real(p1)),l2=(imag(p1)),l3=(real(p2)),l4=(imag(p2)),
bailout=16,iter=0:
t1=(iter==l1),t2=(iter==l2),t3=(iter==l3),t4=(iter==l4),
...
test1=(iter<limit),test0=1-test0,test2=(iter!=limit)
z=conj(z-zn)*test2+conj(zn),z2=z*z,z4=z2*z2,z1=((z4*z-1)/(4*z4+(z4==0)))+d1,
z=(z2+c)*test1+(z-z1)*(1-test1),
test3=(test3 || (|z|>b1))
z=z*(1-(test3 && test0 && test1))
iter=iter+(1.099,0.0)
...
test1=(iter<limit),test0=1-test0,test2=(iter!=limit)
z=conj(z-zn)*test2+conj(zn),z2=z*z,z4=z2*z2,z1=((z4*z-1)/(imag(p1)*z4+(z4==0)))+d1,
z=(z2+c)*test1+(z-z1)*(1-test1),
test3=(test3 || (|z|>b1))
z=z*(1-(test3 && test0 && test1))
iter=iter+(2.099,0.0)
...
test0=1,b1=16,b2=0.0001,test3=0,d1=conj(0.0005455/pixel):
test1=(iter<limit),test0=1-test0,test2=(iter!=limit)
z=(z-zn)*test2+zn,z2=z*z,z4=z2*z2,z1=((z4*z-1)/(imag(p1)*z4+(z4==0)))+d1,
z=(z2+c)*test1+(z-z1)*(1-test1),
test3=(test3 || (|z|>b1))
z=z*(1-(test3 && test0 && test1))
iter=iter+(2.099,0.0)
...
z=c=sinh((-0.7456,0.2)*pixel)*sqr(pixel)-conj(0.1/pixel)-flip(0.1/pixel),
d1 = conj(0.000004550/pixel) , d4 = 4*d1
z1 = 1.5*z+d1 , z2 = 2.25*z+d1 , z3 = 3.375*z+d1 , z4 = 11.0625*z+d1,
l1=(real(p1)),l2=(imag(p1)),l3=(real(p2)),l4=(imag(p2)),
bailout=16,iter=0:
...
c1=(-0.7456,0.2)*pixel,c2=pixel*pixel,c3=conj(0.10/pixel)+flip(0.10/pixel)
...
c=pixel+pixel,
z=sin(flip(imag(1-pixel))*conj(tan(pixel))-conj(0.10/pixel)-flip(0.010/pixel)),
d1 = conj(0.0000455/pixel) , d4 = 4*d1
z1 = 1.5*z+d1 , z2 = 2.25*z+d1 , z3 = 3.375*z+d1 , z4 = 11.0625*z+d1,
l1=(real(p1)),l2=(imag(p1)),l3=(real(p2)),l4=(imag(p2)),
bailout=16,iter=0:
