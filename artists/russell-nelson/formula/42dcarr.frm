...
z=(flip(imag(1-pixel))*conj(tan(pixel))-conj(0.10/pixel)-flip(0.010/pixel)),
...
c=(conj(0.5-pixel)*conj(pixel)-sinh(0.10/pixel)-flip(0.010/pixel)),
z=(flip(imag(1-pixel))/log(tan(pixel))-conj(0.10/pixel)-flip(0.010/pixel)),
d1=(conj(0.00004550/pixel)) , d4=4*d1
z1=1.5*z+d1 , z2=2.25*z+d1 , z3=3.375*z+d1 , z4=11.0625*z+d1
l1=(real(p1)),l2=(imag(p1)),l3=(real(p2)),l4=(imag(p2)),
bailout=16,iter=0:
...
z=sqr(flip(2*(1-pixel))-sqrt(sqrt(3*pixel-(0.10/pixel)-flip(0.010/pixel)))),
c=sin(conj(-0.5545,-0.30009)),
