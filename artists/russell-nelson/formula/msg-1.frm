...
BJ-SG-G-1-g020   {;Modified Sylvie Gallet [101324,3444], 1996
  ...
  c = z = pixel
  z1 = c1 = 1.5*z , z2 = c2 = 2.25*z , z3 = c3 = 3.375*z , z4 = c4 = 5.0625*z , z5 = c5 = z*z*z , z6 = c6 = z*z*z*z*z*z*z*z*z
...
BJ-SG-G-1-g023   {;Modified Sylvie Gallet [101324,3444], 1996
  ; 0 < real(p1) < imag(p1) < real(p2) < imag(p2) < maxiter, periodicity=0
  c = z = pixel, c0=(0.08638,-0.4922)
  z1 = c1 = fn1(1.5*z) , z2 = c2 = fn2(2.25*z) , z3 = c3 = fn3(3.375*z) , z4 = c4 = fn4(5.0625*z) , z5 = c5 = z*z*z , z6 = c6 = z1*z2*z3*z4*z5
  l1 = real(p1) , l2 = imag(p1) , l3 = real(p2) , l4 = imag(p2) , l5 = real(p3) , l6 = imag(p3)
  bailout = 16 , iter = 0 :
   t1 = (iter==l1) , t2 = (iter==l2) , t3 = (iter==l3) , t4 = (iter==l4) , t5 = (iter==l5) , t6 = (iter==l6)
...
BJ-SG-G-1-g029   {;Modified Sylvie Gallet [101324,3444], 1996
  ; 0 < real(p1) < imag(p1) < real(p2) < imag(p2) < maxiter, periodicity=0
  c = z = pixel*(0.0,1.0)
  z1 = c1 = fn1(1.5*z) , z2 = c2 = fn2(2.25*z1) , z3 = c3 = fn3(3.375*z2) , z4 = c4 = fn4(z*c*z3)*pixel
...
BJ-SG-G-1-g030   {;Modified Sylvie Gallet [101324,3444], 1996
  ; 0 < real(p1) < imag(p1) < real(p2) < imag(p2) < maxiter, periodicity=0
  c = z = pixel*(0.1,1.0)
  z1 = c1 = fn1(1.5*z) , z2 = c2 = fn2(2.25*z1) , z3 = c3 = fn3(3.375*z2) , z4 = c4 = fn4(z1*c2*z3)*pixel
  l1 = real(p1) , l2 = imag(p1) , l3 = real(p2) , l4 = imag(p2)
  bailout = 16 , iter = 0 :
   t1 = (iter==l1) , t2 = (iter==l2) , t3 = (iter==l3) , t4 = (iter==l4)
   z = z*(1-(t1||t2||t3||t4)) + z1*t1 + z2*t2 + z3*t3 + z4*t4
...
BJ-SG-G-1-g028   {;Modified Sylvie Gallet [101324,3444], 1996
  ; 0 < real(p1) < imag(p1) < real(p2) < imag(p2) < maxiter, periodicity=0
  c = z = pixel*(0.0,1.0)
  z1 = c1 = fn1(1.5*z) , z2 = c2 = fn2(2.25*z) , z3 = c3 = fn3(3.375*z) , z4 = c4 = fn4(z*c*z)*pixel
  l1 = real(p1) , l2 = imag(p1) , l3 = real(p2) , l4 = imag(p2)
  bailout = 16 , iter = 0 :
   t1 = (iter==l1) , t2 = (iter==l2) , t3 = (iter==l3) , t4 = (iter==l4)
   z = z*(1-(t1||t2||t3||t4)) + z1*t1 + z2*t2 + z3*t3 + z4*t4
...
BJ-SG-G-1-g034   {;Modified Sylvie Gallet [101324,3444], 1996
  ; 0 < real(p1) < imag(p1) < real(p2) < imag(p2) < maxiter, periodicity=0
  c = z = pixel*(0.1,1.0)
  z1 = c1 = fn1(1.5*z*z*z) , z2 = c2 = fn2(2.25*z1) , z3 = c3 = fn3(3.375*z2) , z4 = c4 = fn4(z1*c2*z3)*(1/pixel)
  l1 = real(p1) , l2 = imag(p1) , l3 = real(p2) , l4 = imag(p2)
  bailout = 16 , iter = 0 :
   t1 = (iter==l1) , t2 = (iter==l2) , t3 = (iter==l3) , t4 = (iter==l4)
   z = z*(1-(t1||t2||t3||t4)) + z1*t1 + z2*t2 + z3*t3 + z4*t4
...
BJ-SG-G-1-g038   {;Modified Sylvie Gallet [101324,3444], 1996
  ; 0 < real(p1) < imag(p1) < real(p2) < imag(p2) < maxiter, periodicity=0
  c = z = pixel*(0.1,1.0)
  z1 = c1 = fn1(1.5*z*z) , z2 = c2 = fn2(2.25*z1*z*z*z) , z3 = c3 = fn3(3.375*z2*z*z*z*z) , z4 = c4 = fn4(z1*c2*z3)*(1/pixel)
  l1 = real(p1) , l2 = imag(p1) , l3 = real(p2) , l4 = imag(p2)
  bailout = 16 , iter = 0 :
   t1 = (iter==l1) , t2 = (iter==l2) , t3 = (iter==l3) , t4 = (iter==l4)
   z = z*(1-(t1||t2||t3||t4)) + z1*t1 + z2*t2 + z3*t3 + z4*t4
...
BJ-SG-G-1-g069   {;Modified Sylvie Gallet [101324,3444], 1996
  ; 0 < real(p1) < imag(p1) < real(p2) < imag(p2) < maxiter, periodicity=0
  c = z = pixel*(0.1,1.0)
  z1 = c1 = fn1(1.5*z)*(0.1,1.0) , z2 = c2 = fn2(2.25*z1)*(0.1,1.0) , z3 = c3 = fn3(3.375*z2)*(0.1,1.0) , z4 = c4 = fn4(z1*c2*z3)*pixel
  l1 = real(p1) , l2 = imag(p1) , l3 = real(p2) , l4 = imag(p2)
  bailout = 16 , iter = 0 :
   t1 = (iter==l1) , t2 = (iter==l2) , t3 = (iter==l3) , t4 = (iter==l4)
   z = z*(1-(t1||t2||t3||t4)) + z1*t1 + z2*t2 + z3*t3 + z4*t4
...
BJ-SG-G-1-g070   {;Modified Sylvie Gallet [101324,3444], 1996
  ; 0 < real(p1) < imag(p1) < real(p2) < imag(p2) < maxiter, periodicity=0
  c = z = pixel*(0.1,1.0)
  z1 = c1 = 1.5*z , z2 = c2 = fn1(fn3(2.25*z1)) , z3 = c3 = 3.375*z2 , z4 = c4 = fn2(fn4(5.0625*z3))^z*z*z ,  z5 = c5 = z*z*z , z6 = c6 = z*z*z*z*z*z*z*z*z
  l1 = real(p1) , l2 = imag(p1) , l3 = real(p2) , l4 = imag(p2) ,  l5 = real(p3) , l6 = imag(p3)
  bailout = 16 , iter = 0 :
   t1 = (iter==l1) , t2 = (iter==l2) , t3 = (iter==l3) , t4 = (iter==l4) , t5 = (iter==l5) , t6 = (iter==l6) 
...
BJ-SG-G-1-g071   {;Modified Sylvie Gallet [101324,3444], 1996
  ; 0 < real(p1) < imag(p1) < real(p2) < imag(p2) < maxiter, periodicity=0
  pixel=-abs(real(pixel))+flip(imag(pixel)),                    ;Borrowed, not stolen from Bob Carr   
  m=conj(0.0130/pixel)+flip(0.0020/pixel)+tanh(0.0010/pixel),   ;             "
  z=(pixel+(pixel^2.18)+m^6)-0.5                                ;             "
  c=cabs(sqr(2*(pixel)-m))                                      ;             "
  z1 = c1 = 1.5*z , z2 = c2 = fn1(2.25*z1) , z3 = c3 = fn4(3.375*z2) , z4 = c4 = fn2(5.0625*z3)^fn3(z*z*z) 
  l1 = real(p1) , l2 = imag(p1) , l3 = real(p2) , l4 = imag(p2) , 
  bailout = 16 , iter = 0 :
   t1 = (iter==l1) , t2 = (iter==l2) , t3 = (iter==l3) , t4 = (iter==l4) 
...
BJ-SG-G-1-g047   {;Modified Sylvie Gallet [101324,3444], 1996
  ; 0 < real(p1) < imag(p1) < real(p2) < imag(p2) < maxiter, periodicity=0
  c = z = pixel*(0.1,1.0)
  z1 = c1 = fn1(1.5*z/z/z) , z2 = c2 = fn2(sqrt(2.25*z1)) , z3 = c3 = fn3(conj(3.375*z2))*(1/pixel) , z4 = c4 = fn4(z1*c2*z3)*((0.1,1.0)/pixel)
  l1 = real(p1) , l2 = imag(p1) , l3 = real(p2) , l4 = imag(p2)
  bailout = 16 , iter = 0 :
   t1 = (iter==l1) , t2 = (iter==l2) , t3 = (iter==l3) , t4 = (iter==l4)
   z = z*(1-(t1||t2||t3||t4)) + z1*t1 + z2*t2 + z3*t3 + z4*t4
