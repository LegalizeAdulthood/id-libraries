...
; you get it from the lake, you will see waves of color that runs from the p1 and
; are distorted over the entire lake, but if you get it from outside of the lake,
; those waves are too close one to another that moire patterns begin to appear
; ..
...
;
; In this formula, you will use fn1 to change z, and that make great changes to
; the inside options.
