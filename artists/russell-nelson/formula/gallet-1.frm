; formula for "la_Veuve_Noire" and "SpiderTurtleBeacon"
; -----------------------------------------------------
Newton_z3_sinz2 { ; Sylvie Gallet [101324,3444], 1995
...
; Formula for "Folies_Bergere" and "Feathers"
; -------------------------------------------
newton_reel_1 (ORIGIN) { ; Sylvie Gallet [101324,3444], 1995
   z = pixel , x = real(z) , y = imag(z) :
   x2=x*x , y2=y*y , x3=x2*x , y3=y2*y   ; x^3-y = 0
   d = 1+9*x2*y2                         ; y^3+x = 0
...
; formula for "untitled_4"
; ------------------------
Gmandel_1 {     ; Sylvie Gallet [101324,3444], 1995
                ; bailout = p1
...
; Formula for "Lucky bag", "manj000" and "manj001"
; ------------------------------------------------
mandel-julia {  ; Sylvie Gallet [101324,3444], 1995
...
; Formula for "Lucky bag II", "manm000" and "manm001"
; ---------------------------------------------------
mandel-mandel { ; Sylvie Gallet [101324,3444], 1995
                ; requires "periodicity=0" (<g> command)
...
; Formula for "Lucky bag III" with a bug !
; ----------------------------------------
...
j_reel_1 {      ; Sylvie Gallet [101324,3444], 1995
                ; requires "float=no"
   z = pixel , x = real(z) , y = imag(z) :
...
Newt_Exp_Inv (YAXIS) { ; Sylvie Gallet [101324,3444], 1995
                       ; equation e^z-1 = 0
                       ; solution z = 0
   z = (0,-1)/pixel : 
   z = z-1+exp(-1*z)
